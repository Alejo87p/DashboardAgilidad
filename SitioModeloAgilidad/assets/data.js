...
const PANELES = {
  ...
  quecomo: {
    ...
    <p>El rol aplica de forma transversal a los tres tipos de equipo: <b>en todos existe siempre un Líder Técnico</b>. A nivel de laboratorio, la función se escala en el <b>Líder de TI Escalado</b>, contraparte técnica del Líder de Producto del Laboratorio.</p>
...
const ROLES = [
  ...
  },
  {
    ...
    r: ["Asegura que el equipo mantenga el foco en la entrega de valor al usuario final",
        ...
        "Asume la propiedad técnica del conocimiento y de la relación con el proveedor: valida estimaciones, cuestiona horas facturadas y exige la garantía contractual",
        "Escala impedimentos estructurales al EAT apoyado en el Andon Digital",
        "Ejerce coaching técnico directo al equipo, más allá del proceso ágil"],
    m: ["Velocidad y eficiencia: Flow Time y Flow Efficiency", "Calidad técnica: estabilidad, reducción de defectos, cobertura de pruebas", "Gestión del proveedor: cumplimiento de garantías y precisión de estimaciones frente a horas facturadas", "Impacto operativo: costos y confiabilidad de los sistemas", "Flow Distribution equilibrado", "Cultura técnica: retención de talento y colaboración"],
  ...
  },
  {
    ...
    d: "Responsable de la eficiencia operativa del sistema de flujo. Monitorea métricas, facilita mejoras y ayuda a balancear la carga de trabajo.",
    ...
    m: ["Cycle Time y Lead Time", "Throughput", "WIP Aging", "Flow Efficiency"],
    meta: { "Responsable de": "Salud del sistema de flujo, políticas de WIP", "Facilita": "Daily Kanban, Revisión de Operaciones y Riesgos", "Nota": "En equipos pequeños una misma persona puede asumir Dueño de Servicio y Líder Técnico" }
  },
  {
  ...
  },
  {
    ...
    d: "Diseña la arquitectura técnica del proyecto, asegura la calidad del software y promueve la innovación tecnológica.",
  ...
  {
    id: "lt-sm-proy", n: "Líderes Técnicos del Proyecto", cat: "proy", catTxt: "Proyectos",
    d: "Facilitan la ejecución ágil del proyecto, eliminando impedimentos y asegurando que el equipo mantenga un alto rendimiento sostenible.",
    ...
    m: ["Impedimentos resueltos", "Predictibilidad de la entrega", "Clima y autoorganización del equipo"],
    meta: { "Convoca": "Scrum Diario del EAT, Daily Scrum Escalado, Retrospectiva del Sprint" }
  },
  {
...
const INDICE = [
  ...
  { t: "Líder Técnico", p: "roles.html#lt", pg: "Roles", a: "proveedor swarming wip ciclo del como calidad tecnica", x: "Conduce el ciclo del Cómo: ejecución, calidad técnica y sostenibilidad de la entrega. Incorpora autoridad técnica sobre arquitectura, calidad y viabilidad. Gestiona activamente al proveedor validando estimaciones y exigiendo garantía contractual. Orquesta el WIP y el Swarming. Facilita Daily y Retrospectiva y co-facilita la Planificación del Sprint." },
